...
// @version     1.1
// @author      Colin Whelan
// @description Add a button to copy image URLs in the media library OR select and export public URL of each.
// ==/UserScript==
...
(function() {
    ...
    function showNotification(container, message) {
        ...
        console.log(notification.style.left)
    ...
    function addExportButton() {
        ...
        button.onclick = function(event) {
            ...
            for (const container of allSelectedAssets) {
              if(container.querySelector('.publicURL')){
                urls.push(container.querySelector('.publicURL').innerText)
              }
            }
